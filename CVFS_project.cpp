...
void man(char *name)
{
    ...
    else if(strcmp(name,"claseall") == 0)
    {
...
void DisplayHelp()
{
    ...
    printf("fstat : To Display information of file using file descriptior\n");
    ...
    while(1)
    {
        ...
        else if(count == 2)
        {
            ...
            else if(strcmp(command[0],"write") == 0)
            {
                ...
                if(ret == 0)
                {
                    printf("ERROR : Incorrect paramentr\n");
                    continue;
                }
                ...
                if(ret = -2)
                {
                    printf("ERROR : There is no suffient memory to write\n");
                }
                if(ret == -3)
                {
        ...
        else if(count == 3)
        {
            if(strcmp(command[0],"create") == 0)
            {
                ...
                if(ret >= 0)
                {
                    printf("File is succesfully created with file description : %d\n",ret);
                }
                if(ret == -1)
                {
                    printf("ERROR : Incorrect parameter\n");
